...
@section('content')
    <div class="container">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="fw-bold">
                        ...
                        <div class="fs-6 text-gray-700">{{translate('Please Configure SMTP Setting to work all email sending functionality')}},
                            <a href="{{ route('smtp_settings.index') }}"> {{ translate('Configure Now') }}</a></div>
                    </div>
                </div>
            </div>
        @endif
        <div class="row g-5 g-xl-8">
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="{{route('all_orders.index')}}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="{{route('categories.index')}}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="{{route('brands.index')}}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <div class="fw-bold text-white">{{ translate('Total') }} {{ translate('Product Brands') }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex flex-stack">
                            <!--begin::Title-->
                            <h4 class="fw-bolder text-gray-800 m-0">{{translate('Total published products')}}</h4>
                            <!--end::Title-->
                            <!--begin::Menu-->
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex flex-stack">
                            <!--begin::Title-->
                            <h4 class="fw-bolder text-gray-800 m-0">{{translate('Total sellers products')}}</h4>
                            <!--end::Title-->
                            <!--begin::Menu-->
                            {{-- <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
                        ...
                        <!--begin::Chart-->
                        <div class="d-flex flex-center w-100">
                            <div class="mixed-widget-18-charts" data-kt-chart-color="success" style="height: 300px"></div>
                        </div>
                        <!--end::Chart-->
                        <!--begin::Content-->
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex flex-stack">
                            <!--begin::Title-->
                            <h4 class="fw-bolder text-gray-800 m-0">{{translate('Total admin products')}}</h4>
                            <!--end::Title-->
                            {{-- <!--begin::Menu-->
                            <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
                                                ...
                                                <td>
                                                    <div class="symbol symbol-45px me-2">
                                                        <span class="symbol-label">
                                                            <img src="{{ static_asset('assets/img/placeholder.jpg') }}" data-src="{{ uploaded_asset($product->thumbnail_img) }}"alt="{{  $product->getTranslation('name')  }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
