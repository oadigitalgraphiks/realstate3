        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Property Amenities</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Property Amenities</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a href="{{ route('property_amenities.create') }}" class="btn btn-primary">
                                    {{ translate('Add New Property Amenities') }}
                                </a>
                                <!--end::Add product-->
                            </div>
                            <!--end::Card toolbar-->
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-200px">{{ translate('Property Amenity') }}</th>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <!--begin::Table row-->
                                        @foreach ($property_amenities as $key => $property_amenity)
                                            <tr>
                                                <!--begin::Checkbox-->
                                                <td class="text-center pe-0">
                                                    <span
                                                        class="fw-bolder">{{$property_amenity->id}}</span>
                                                </td>
                                                <!--begin::Category=-->
                                                <td>
                                                    <div class="d-flex" style="justify-content: center;">
                                                        ...
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a href="{{ route('property_amenities.edit', ['id' => $property_amenity->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1"
                                                                data-kt-ecommerce-property_type-filter="property_type_name">
                                                                <div class="badge badge-light-success">
                                                                    {{ $property_amenity->getTranslation('name') }}</div>
                                                            </a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </div>
                                                ...
                                                <!--end::Qty=-->
                                                <td class="text-center pe-0">
                                                    @if ($property_amenity->icon != null)
                                                        <span class="avatar avatar-square avatar-xs width_75">
                                                            <img src="{{ uploaded_asset($property_amenity->icon) }}"
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-href="{{ route('property_amenities.destroy', $property_amenity->id) }}">
