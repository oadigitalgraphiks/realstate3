                                    ...
                                    @foreach ($countries as $key => $country)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                        <a href="{{ route('property_countries.edit', $country->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <a href="{{ route('property_countries.destroy', $country->id) }}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"
                                                    data-href="{{ route('property_countries.destroy', $country->id) }}">
