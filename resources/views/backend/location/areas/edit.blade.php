                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="py-2">
                                    <label class="required form-label">{{ translate('Code') }}</label>
                                ...
                                <div class="py-2">
                                    ...
                                    <select required class="form-select mb-2"  data-placeholder="Select an option" name="city_id" id="city_id">
                                        @if($data->city)
                                        <option selected value="{{$data->city_id}}">{{$data->city->name}}</option>
                                        @endif
                                    </select>
                                </div>
...
@section('script')
    ...
    <script>
        ...
        $('#city_id').select2({
        ajax: {
            url: "{{route('property_cities.index')}}",
            dataType: 'json',
            delay: 250,
