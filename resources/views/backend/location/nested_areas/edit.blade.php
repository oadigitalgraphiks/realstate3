                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="py-2">
                                    ...
                                    <select required class="form-select mb-2"  data-placeholder="Select an option" name="parent" id="area_id">
                                        @if($data->area)
                                        <option selected value="{{$data->area->id}}">{{$data->area->name}}</option>
                                        @endif
                                    </select>
                                </div>
...
@section('script')
    ...
    <script>
        ...
        $('#area_id').select2({
        ajax: {
            url: "{{route('property_areas.index')}}",
            dataType: 'json',
            delay: 250,
